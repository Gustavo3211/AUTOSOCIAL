      ...
      <div className="max-w-lg mx-auto px-4 py-6 space-y-6">
        ...
        {activeTab === "sell" && (
          <>
            ...
            <Card className="p-6 bg-gradient-to-br from-primary/10 to-background border-primary/20">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Parceiro AutoGRID</p>
                </div>
              </div>
            ...
            <Button 
              ...
              variant="outline" 
              className="w-full h-auto py-4 border-2 border-primary/50 hover:bg-primary/10"
            >
        ...
        <div>
          <h2 className="text-xl font-bold mb-4">
            {activeTab === "buy" ? "Carros Disponíveis" : "Seus Anúncios"}
          </h2>
